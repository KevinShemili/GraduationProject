                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="" class="dropdown-item">TextBlob</a>
                    ...
                    <div class="w-100">
                        ...
                        <div class="w-100">
                            <p class="text-left pl-3 mb-4">
                                TextBlob is a Python library for processing textual data. It provides a simplified and intuitive API for common natural
                                language processing tasks such as sentiment analysis, part-of-speech tagging, and noun phrase extraction. TextBlob is
                                easy to use and beginner-friendly, making it an ideal tool for individuals and small businesses with limited technical
                                expertise.
                            </p>
                            <p class="text-left pl-3">
                                TextBlob may not perform as well as more advanced NLP models like BERT on complex language structures and nuances.
                                Additionally, TextBlob may require additional pre-processing steps for certain NLP tasks. However, for simple NLP tasks
                                and for individuals and small businesses with limited resources, TextBlob can be a useful tool for processing textual data
